= page-title 'Player Registration - Mutambo' replace=true separator=' → '
      ...
      .flex.flex-col.justify-center.pt-4.pb-80 class='sm:px-6 lg:px-8'
        ...
        div class='sm:mx-auto sm:w-full sm:max-w-md'
          ...
          h2.mt-2.mx-6.text-center.text-xl.font-medium.text-neutral-900
            ...
            | {{' • '}}
            = if model.itp.val.season
              | {{model.itp.val.league.val.name}}, {{model.itp.val.season.val.name}}
          ...
          .bg-white.border.border-neutral-200.px-6.py-10.mx-2.rounded-lg class='sm:rounded-lg sm:px-10'
            ...
            = else
              ...
              .space-y-6
                ...
                = if model.itp.val.settings.val.required_info.player.full_name
                  div
                ...
                = if model.itp.val.settings.val.required_info.player.display_name
                  div
                ...
                = if model.itp.val.settings.val.required_info.player.birthday
                  div
                ...
                = if model.itp.val.settings.val.required_info.player.gender
                  div
                ...
                = if model.itp.val.settings.val.required_info.player.address
                  div
                ...
                = if model.itp.val.settings.val.required_info.player.phone
                  div
