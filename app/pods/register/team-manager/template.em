= page-title 'Manager Registration - Mutambo' replace=true separator=' → '
    ...
    .flex.flex-col
      .flex.flex-col.justify-center.pt-4.pb-80 class='sm:px-6 lg:px-8'
        ...
        div class='sm:mx-auto sm:w-full sm:max-w-md'
          h2.mt-6.mx-6.text-center.text-2xl.font-extrabold.text-neutral-900
            | Manager Registration
          h2.mt-2.mx-6.text-center.text-xl.font-medium.text-neutral-900
            | {{model.itm.val.team.val.name}}
            | {{' • '}}
            = if model.itm.val.season
              | {{model.itm.val.league.val.name}}, {{model.itm.val.season.val.name}}
        ...
        .mt-8 class='sm:mx-auto sm:w-full sm:max-w-md'
          .bg-white.border.border-neutral-200.px-6.py-10.mx-2.rounded-lg class='sm:rounded-lg sm:px-10'
            ...
            = if false
              p.text-center Manager registration is closed.

            = else

              .space-y-6

                = if model.itm.val.settings.val.required_info.manager.full_name
                  div
                ...
                = if model.itm.val.settings.val.required_info.manager.display_name
                  div
                ...
                = if model.itm.val.settings.val.required_info.manager.birthday
                  div
                ...
                = if model.itm.val.settings.val.required_info.manager.gender
                  div
                ...
                = if model.itm.val.settings.val.required_info.manager.address
                  div
                ...
                = if model.itm.val.settings.val.required_info.manager.phone
                  div
