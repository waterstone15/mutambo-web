    ...
    .flex.flex-col
      .flex.flex-col.justify-center.pt-4.pb-80 class='sm:px-6 lg:px-8'
        ...
        h3.mt-3.mx-6.text-center.text-lg.font-medium.text-neutral-900
          = if (get this 'model.illst.val.league.val.name')
            | {{get this 'model.illst.val.league.val.name'}}
          = if (get this 'model.illst.val.season.val.name')
            | {{', '}}{{get this 'model.illst.val.season.val.name'}}
