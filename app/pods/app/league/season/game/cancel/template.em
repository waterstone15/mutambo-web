    ...
    .flex.flex-col.w-full
      .px-8.flex.justify-between.items-center.border-b.border-neutral-100 class='min-h-[80px]'
        .inline-flex.items-center.flex-wrap class='md:h-[48px] py-4 md:py-0'
          ...
          % Breadcrumb [
            @goto={hash route='app.league.season.game.cancel' query=(hash league_id=model.league.meta.id season_id=model.season.meta.id)}
            @text='Delete Game'
          ]
      ...
      .p-8
        ...
        .space-y-6 class='sm:w-full sm:max-w-md'
          ...
          div
            ...
            label
              .inline-flex: | Type
              .inline-flex.ml-1.py-px.px-1.rounded-sm.border.border-neutral-100.bg-white: | CANCEL
